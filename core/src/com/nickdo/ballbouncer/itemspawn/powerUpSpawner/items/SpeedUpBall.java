...
public class SpeedUpBall extends Item {

    public SpeedUpBall(World world, Platform platform, Ball ball, StatsTracker statsTracker) {
        super(world, platform, ball, statsTracker);
        this.texture = new Texture("items/fast.png");
    }

    @Override
    public void activate() {
        GlobalData.getInstance().setVerticalBallForce(Constants.VERTICAL_BALL_VELO_FAST);
        featureActive = true;
    }
    ...
    public void pickedUp() {
        ...
        ball.getBody().setGravityScale(Constants.VERTICAL_BALL_GRAVITY_SCALE_FAST);
    }
}
